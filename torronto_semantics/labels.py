...
labels = [
    #       name                     id    kittiId,    trainId   category            catId     hasInstances   ignoreInEval   ignoreInInst   color
    Label(  'Unclassified'         ,  0 ,        0 ,         0 , 'void'            , 0       , False        , False         , True       , (  0,   0, 255) ),
    Label(  'Ground'               ,  1 ,        1 ,         1 , 'void'            , 1       , False        , False         , True       , (  0,  95, 160) ),
    Label(  'Road_markings'        ,  2 ,        2 ,         2 , 'void'            , 2       , False        , False         , True       , (  0, 190,  64) ),
    Label(  'Natural'              ,  3 ,        3 ,         3 , 'void'            , 3       , False        , False         , True       , ( 31, 255,   1) ),
    Label(  'Building'             ,  4 ,        4 ,         4 , 'void'            , 4       , False        , False         , True       , (132, 255,   0) ),
    Label(  'Utility_line'         ,  5 ,        5 ,         5 , 'void'            , 5       , False        , False         , True       , (222, 255,   0) ),
    Label(  'Pole'                 ,  6 ,        6 ,         6 , 'void'            , 6       , False        , False         , True       , (255, 190,   0) ),
    Label(  'Car'                  ,  7 ,        7 ,         7 , 'flat'            , 7       , False        , False        , False       , (255, 255,  10) ),
    Label(  'Fence'                ,  8 ,        8 ,         8 , 'flat'            , 8       , False        , False        , False       , (255,   0,   0) ),
    ]
#--------------------------------------------------------------------------------
...
if __name__ == "__main__":
    ...
    catid = id2catid[id]
    print("Label ID for ID '{id}': {catid}".format( id = id, catid=catid)  )
