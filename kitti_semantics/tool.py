...
class ConfigSensatUrban:
    k_n = 16  # KNN
    num_layers = 5 #5 # Number of layers
    num_points = 4096 * 11 #70000 #65536  # Number of input points
    num_classes = 15  # Number of valid classes
    ...
    sub_sampling_ratio = [4, 4, 4, 4, 2]# #[4, 4, 4, 4]  # sampling ratio of random sampling at each layer
    d_out = [16, 64, 128, 256, 512] #[16, 64, 128, 256] # # feature dimension

    noise_init = 2.5 #3.5  # noise initial parameter
